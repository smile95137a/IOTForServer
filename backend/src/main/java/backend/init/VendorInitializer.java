...
//
//        // 2. 創建店家，並關聯到廠商
//        Store store1 = createStore(vendorA, "Store 1", "123 Main St", UUID.randomUUID().toString());
//        Store store2 = createStore(vendorA, "Store 2", "456 Second Ave", UUID.randomUUID().toString());
//
//        // 3. 創建桌台，並關聯到店家
...
//        vendor.setUid(UUID.randomUUID().toString());
//
...
//            poolTable.setUid(UUID.randomUUID().toString());
